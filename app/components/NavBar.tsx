...
function NavLink({href, children}: NavLinkProps) { 
    return( 
	<Link href={href} className="relative text-gray-700 hover:text-black font-subheading group transition-colors duration-200 pt-2">
            {children}
...
export default function NavBar() {
    ...
    return(
        <div className="flex justify-center items-center space-x-10 p-0 mx-4">
